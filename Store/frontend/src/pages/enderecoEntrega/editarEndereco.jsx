...
export function EditarEndereco() {
    ...
    const idCliente = localStorage.id;
    const {
        register,
        handleSubmit,
        watch,
    ...
    const onSubmit = async (data) => {
        ...
        console.log(data);
        const teste = {}
        teste.endereco =  data.endereco 

        try {
            axios.post(`http://localhost:3001/editarEnederecoEntrega/${id}/${idCliente}`, teste).then(res => {
    ...
    return (
        <div>
            ...
            <form className="FormSignUp" onSubmit={handleSubmit(onSubmit)}>
                ...
                <button className="buttonLoginStore">Editar</button>
